...
const episodes = [
  ...
  },
  {
    id: 3,
    title: "Episode 3",
    embedCode: `<iframe src="https://drive.google.com/file/d/1T4rPYqqZysRkoPNFNNcc9URNaLPo0EGl/preview" width="80%" height="80%" allow="autoplay; fullscreen"></iframe>`,
  },
  {
    id: 4,
    title: "Episode 4",
    embedCode: `<iframe src="https://drive.google.com/file/d/1tHDQZ9OGFo49SmZaKE4npYCi0dsTeqcJ/preview" width="80%" height="80%" allow="autoplay; fullscreen"></iframe>`,
  },
];
        ...
        <div className="w-1/5 bg-gray-900 p-4 overflow-y-auto">
          ...
          <div className="space-y-2">
            {episodes.map((episode, index) => (
              ...
              >
                <center>
                  {index + 1} {/* Displays just the episode number */}
                </center>
              </button>
            ))}
          </div>
